//ImageModal component to display images from third party API to use as a inspiration or writing prompt
...
export default function ImageModal({ isOpen, onClose }) {
  ...
  //getting images from pexels.com api
  ...
  //creating a random number to pull random image from API
